			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select">
						...
						<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Pimpinan</option>
						<option value="4" <?php echo isset($meta['type']) && $meta['type'] == 4 ? 'selected' : '' ?>>Staff_QA</option>
						<option value="5" <?php echo isset($meta['type']) && $meta['type'] == 5 ? 'selected' : '' ?>>Pimpinan_QA</option>
					</select>
				</div>
				<div class="form-group col-6">
